...
<html>
  <head>
    ...
    <title>Update Transaction Password - Elite Site Optimizer</title>
  </head>
  <body>
    <div id="app" >
                ...
                <div class="van-sticky">
                  <div class="van-nav-bar van-hairline--bottom van-safe-area-top  bg-[#000000] text-[#FFFFFF]">
                    ...
                    <a onclick="goBack()">  <div class="van-nav-bar__left van-haptics-feedback text-[#FFFFFF]">
                      ...
                      <div class="van-nav-bar__title van-ellipsis text-[#FFFFFF]">Update Transaction Password</div>
                      <!---->
                    </div>
                  </div>
                </div>
                  ...
                  <div class="van-cell van-field">
                    ...
                    <div class="van-cell__value van-field__value">
                      <div class="van-field__body">
                        <input type="password" id="van-field-4-input" name="currentpass" class="van-field__control" placeholder="Old Password">
              ...
              <div class="w-full flex flex-col mt-4">
                ...
                <div class="w-full mt-2 overflow-hidden shadow">
                  <div class="van-cell van-field">
                    ...
                    <div class="van-cell__value van-field__value">
                      <div class="van-field__body">
                        <input type="password" id="van-field-5-input" name="newpass" class="van-field__control" placeholder="New Password">
              ...
              <div class="w-full flex flex-col mt-4">
                ...
                <div class="w-full mt-2 overflow-hidden shadow">
                  <div class="van-cell van-field">
                    ...
                    <div class="van-cell__value van-field__value">
                      <div class="van-field__body">
                        <input type="password" id="van-field-6-input" name="confirmnewpass" class="van-field__control" placeholder="Confirm New Password">

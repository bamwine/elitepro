...
<html>
  <head>
    ...
    <title>Event - Elite Site Optimizer</title>
  </head>
  <body>
    <div id="app" >
          ...
          <div>
              ...
              <div>
                <div class="van-sticky">
                  <div class="van-nav-bar van-hairline--bottom van-safe-area-top  bg-[#000000] text-[#FFFFFF]">
                    ...
                    <div onclick="goBack()">  <div class="van-nav-bar__left van-haptics-feedback text-[#FFFFFF]">
                        <i class="fa fa-angle-left "></i>
                        <!---->
                      </div> </div>
                      <div class="van-nav-bar__title van-ellipsis text-[#FFFFFF]">Event</div>
                      <!---->
                    </div>
                  </div>
                </div>
            ...
            <div class=" w-full min-h-[100vh]">
                <div class="w-full p-6 box-border flex flex-col font-montserrat text-[#666]">
                  <p>
                    <img src="<?php echo base_url();?>phd/tailwind/1688030230167100380.png">
                    <br>
                    <img src="<?php echo base_url();?>phd/tailwind/1688030244605604559.png" alt="" width="933" height="1746">
                    <br>
                    <img src="<?php echo base_url();?>phd/tailwind/168803031692484145.png" alt="" width="933" height="1245">
                  </p>
                </div>
              </div>
            </div>

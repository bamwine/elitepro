                            ...
                            <td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="#" onclick="successrxt('<?php echo $row['tr_id'];?>,<?php echo $row['tr_clt_id'];?>,<?php echo $row['tr_amount'];?>,<?php echo "deposit";?>')"><i class="fa fa-check"></i> successful</a>
													<a class="dropdown-item" href="#" onclick="failedrxt('<?php echo $row['tr_id'];?>')" ><i class="fa fa-trash"></i> Failed</a>
												</div>
												<?php }?>
											</div>
										</td>
